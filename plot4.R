...
par(mfrow = c(2,2))
plot(subData$Date_Time, subData$Global_active_power, type = "l",  col = "black", xlab = "", ylab = "Global Active Power")

plot(subData$Date_Time, subData$Voltage, type = "l",  col = "black", xlab = "datetime", ylab = "Voltage")
...
plot(subData$Date_Time, subData$Global_reactive_power, type = "l",  col = "black", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
